"""Regression checks for the prism-model-drift-loom casebook."""
...
from casebook.harness import assert_expected, prism_model_drift_loom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(prism_model_drift_loom_summary(), assert_expected())
